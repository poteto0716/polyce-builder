# PCFF block copolymer

Two packed PMMA6-b-PS6 diblock chains at 1.110 g/cm³. This is a small model-construction example, not an equilibrated
bulk sample.
...
Sequence: `MMA-MMA-MMA-MMA-MMA-MMA-STY-STY-STY-STY-STY-STY`.
...
```bash
cd examples/polymer_pcff/block_copolymer
./run.sh
```
